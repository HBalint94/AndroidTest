...
public class RatingActivity extends AppCompatActivity {
	...
	private void addListeners() {
		...
		reviewTextView = (TextView) findViewById(R.id.editTextComments);
		...
		submitRating.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				TextView lastReviewTextView = (TextView) findViewById(R.id.labelLastReview);
				lastReviewTextView.setText(reviewText);
			}
		});
	}
}
